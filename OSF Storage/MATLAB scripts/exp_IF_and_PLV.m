...
percentage_ratio= nan(25,40,19, size(possible_ratios,2)); %subject*trial*electrode*ratio
...
%load weights per epoch and condition index with rejected epochs applied
%load('F:\PhD KU Leuven\mind wandering experiment\Results\variables\weights_per_epoch_after_rejection.mat')
...
% we exclude nans (which are rejected epochs)
